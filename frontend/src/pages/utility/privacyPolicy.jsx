        ...
        content: [
          {
            ...
            description: "We collect information that you provide directly to us when using our platform.",
            details: [
              {
                text: "Name, email address, and contact information",
                description: "Basic information required for account creation and communication"
              },
              {
                text: "Business details and professional information",
                description: "Company name, position, industry, and business objectives"
              },
              {
                text: "Profile information and preferences",
                description: "Profile pictures, bios, and user preferences for personalized experience"
              },
              {
                text: "Payment and transaction data",
                description: "Secure payment information and transaction history for financial operations"
              },
              {
                text: "Communication history and preferences",
                description: "Messages, notifications, and communication preferences"
              }
            ]
          },
          {
            subtitle: "Usage Information",
            description: "We automatically collect certain information about your interaction with our platform.",
            details: [
              {
                text: "Log data and device information",
                description: "IP addresses, browser type, operating system, and device identifiers"
              },
              {
                text: "IP address and location data",
                description: "Geographic location for security and service optimization"
              },
              {
                text: "Browser type and settings",
                description: "Browser preferences and settings for optimal user experience"
              },
              {
                text: "Interaction with our services",
                description: "Pages visited, features used, and time spent on platform"
              },
              {
                text: "Performance and error data",
                description: "Technical data to improve service reliability and performance"
              }
            ]
          }
        ]
        ...
        content: [
          {
            ...
            description: "We use your information to provide and improve our services.",
            details: [
              {
              ...
              },
              {
                ...
                description: "Handle financial operations securely and efficiently"
              },
              {
                text: "Send notifications and updates",
                description: "Keep you informed about important changes and opportunities"
              },
              {
              ...
              },
              {
                ...
                description: "Connect you with relevant professionals and opportunities"
              }
            ]
          },
          {
            subtitle: "Improvement and Security",
            description: "We continuously work to enhance our platform's security and user experience.",
            details: [
              {
                text: "Enhance user experience",
                description: "Analyze usage patterns to improve platform features"
              },
              {
                text: "Monitor and prevent fraud",
                description: "Protect users from fraudulent activities and security threats"
              },
              {
      ...
      },
      {
        ...
        content: [
            ...
            details: [
              {
                ...
                description: "Advanced encryption for all sensitive information"
              },
              {
              ...
              },
              {
                ...
                description: "Industry-standard data storage and backup systems"
              },
              {
          ...
          },
          {
            ...
            description: "We maintain clear policies for data retention and deletion.",
            details: [
              {
                text: "Retention periods based on data type",
                description: "Different retention periods for various types of data"
              },
              {
                text: "Automatic deletion of inactive accounts",
                description: "Removal of unused accounts after specified periods"
              },
              {
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            description: "Customize your privacy preferences to suit your needs.",
            details: [
              {
            ...
            details: [
              {
                ...
                description: "Secure transfer of data across international borders"
              },
              {
              ...
              },
              {
                ...
                description: "Implementation of global data protection standards"
              },
              {
                text: "International privacy laws",
                description: "Compliance with various international privacy regulations"
              },
              {
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    This privacy policy may be updated periodically. We encourage you to review it regularly to stay informed about how we protect your information. For any questions or concerns about our privacy practices, please contact our privacy team.
                  </p>
                </div>
              </div>
            </div>
